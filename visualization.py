...
class VolumeVisualizer:
    ...
    def __init__(self):
        ...
        # Full Sail Finance pool colors (USDB pools removed)
        self.pool_colors = {
            'SAIL/USDC': '#00D4FF',    # Bright cyan - Main SAIL pool
            'SUI/USDC': '#FF6B35',     # Bright orange - Main SUI pool
            'IKA/SUI': '#BB86FC',      # Purple - IKA gaming token
            'ALKIMI/SUI': '#03DAC6',   # Teal - ALKIMI protocol
            'USDZ/USDC': '#00E676',    # Bright green - Stable pair
            'USDT/USDC': '#FFD600',    # Yellow - Major stable pair
            'wBTC/USDC': '#F7931A',    # Bitcoin orange
            'ETH/USDC': '#627EEA',     # Ethereum blue
            'WAL/SUI': '#9C27B0',      # Deep purple - WAL protocol
            'DEEP/SUI': '#CF6679'      # Pink - DEEP liquidity
        }
    ...
    def create_altair_correlation_chart(self, df: pd.DataFrame) -> alt.Chart:
        """
        Create Altair correlation chart.
